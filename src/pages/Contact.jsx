        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="w-full max-w-[350px] bg-gray-50 border border-gray-200 rounded-b-lg py-6 px-6 flex justify-center gap-3">
              ...
              <a
                href="mailto:info@ecasiafrica.org"
                className="w-10 h-10 rounded-full bg-[#EA4335] flex items-center justify-center text-white hover:opacity-80 transition-opacity"
                aria-label="Email"
              >
